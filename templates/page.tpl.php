...
<div id="page" class="container <?php print $classes; ?>">
  ...
  <div id="birk-colophon">
  	...
  	<div id="bottom-logos">
	  	<div class="logo">
	  		<img src="<?php echo  base_path() . drupal_get_path('theme', 'birkeland');?>/images/logo-ncoe.png" />
	  	</div>
	  	<div class="logo">
	  		<img src="<?php echo  base_path() . drupal_get_path('theme', 'birkeland');?>/images/logo-uib.png" />
	  	</div>
	  	<div class="logo">
	  		<img src="<?php echo  base_path() . drupal_get_path('theme', 'birkeland');?>/images/logo-unis.png" />
	  	</div>
	  	 <div class="logo">
	  		<img src="<?php echo  base_path() . drupal_get_path('theme', 'birkeland');?>/images/ntnulogo.png" />
	  	</div>
  	</div>
  </div>
